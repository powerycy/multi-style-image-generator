...
description: 当用户要求按指定游戏、动画、小说改编或幻想作品视觉风格生成图片或提示词时使用，支持原神/Genshin Impact、黑神话悟空/Black Myth Wukong、凡人修仙传、诡秘之主/Lord of the Mysteries、宝可梦/Pokemon、星露谷物语/Stardew Valley、潜水员戴夫/Dave the Diver 等风格，并支持 360 度环景照/全景/等距柱状投影模式。适用于在 Codex 中直接出图、只写提示词、真实地点风格化、角色场景、产品或物体场景，以及任何需要生成特定风格视觉内容的任务。触发词包括：生成图、出图、产出一个图、做一张、画一张、直接生成、写提示词、不用出图、360 度环景照、全景图、环景照、等距柱状投影、原神风格、黑神话风格、凡人修仙传风格、修仙风格、诡秘之主风格、克苏鲁蒸汽风格、宝可梦风格、星露谷风格、潜水员戴夫风格。
---
