...
- [x] **Step 3: Implement constants and Keychain helpers**
...
- [x] **Step 4: Implement the secure dialog and resolution order**
...
- [x] **Step 3: Refactor parser and main**
...
- [x] **Step 4: Improve authentication failure guidance**
...
- [x] **Step 5: Run all video tests and verify GREEN**
...
- [x] **Step 3: Update Skill behavior**
...
- [x] **Step 4: Update both READMEs and onboarding eval**
...
- [x] **Step 1: Compile AppleScript without displaying it**

Use `osacompile` against the exact hidden-input AppleScript and expect exit code 0.

- [x] **Step 2: Verify Keychain command shape without a real secret**
...
- [x] **Step 3: Run the full test suite and Skill validator**
