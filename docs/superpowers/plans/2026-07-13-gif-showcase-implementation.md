...
- [x] **Step 1: Replace the HTML demo tests with failing GIF tests**
...
- [x] **Step 1: Decode the embedded sources**
...
- [x] **Step 2: Render spatial parallax frames**
...
- [x] **Step 3: Render panorama viewport frames**
...
- [x] **Step 1: Replace the interactive table in Chinese README**
...
- [x] **Step 2: Replace the interactive table in English README**
...
- [x] **Step 3: Delete the HTML demos**
...
- [x] **Step 1: Visually inspect both GIFs**
