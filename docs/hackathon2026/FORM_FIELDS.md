...
- 作品名称：空间视觉工坊——把平面图变成可探索的 360° 与景深方案
- 作品分类：AI 原生应用
- 搭建平台：GitHub Pages
- 编程语言：JavaScript
- AI 参与度：AI + 手动编码
...
很多图片生成器停在一张图。空间视觉工坊把 7 种风格路由、结构化提示词、360° 全景合同和空间景深串成一条工作流。评委可以直接用内置例图或本地上传，无需账号和 Key；严格 2:1 的全景进入可拖拽预览，普通图片进入普通图或景深位移路径，最后可以下载包含素材来源与降级方式的 JSON。公网版明确不冒充在线生图，也不把近似视差说成模型深度。
